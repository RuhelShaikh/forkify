...
const controlDelete = async function() {
    try {
        ...
        (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
        (0, _recipeViewJsDefault.default).renderMessage((0, _recipeViewJsDefault.default)._delMessage);
    } catch (err) {
        console.error("\uD83D\uDCA5", err);
        (0, _recipeViewJsDefault.default).renderError((0, _recipeViewJsDefault.default)._delError);
    }
};
...
const deleteRecipe = async ()=>{
    const deleteUrl = `${(0, _configJs.API_URL)}${state.recipe.id}?key=${(0, _configJs.KEY)}`;
    try {
...
parcelHelpers.export(exports, "recipeId", ()=>recipeId);
const API_URL = "https://forkify-api.herokuapp.com/api/v2/recipes/";
const TIMEOUT_SEC = 10;
const RES_PER_PAGE = 10;
const KEY = "e1d81983-d1d1-480e-846f-213f3a5f73f1";
const MODAL_CLOSE_SEC = 2.5;
const recipeId = "65a36b08eec55400146c11b9";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    <li class="recipe__ingredient">
      ...
      <div class="recipe__quantity">${ing.quantity && ing.quantity.toString()}
      </div>
